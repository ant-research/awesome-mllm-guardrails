...
| :-------- | :--- | :----------- | :------- | :----------------------- | :---- |
| **SafePyramid** | [SafePyramid: A Hierarchical Benchmark for In-context Policy Guardrailing](https://arxiv.org/abs/2606.29887) | arXiv 2026 | `[T]`,`[D]` | 层次化 in-context policy guardrailing 基准，包含 1K 多轮对话、3K 应用特定策略和 61K+ 自然语言规则，覆盖三档难度 | - |
...
| **StreamSafe** | [SentGuard: Sentence-Level Streaming Guardrails for Large Language Models](https://arxiv.org/abs/2606.02041) | arXiv 2026 | `[T]` | 句子级流式安全基准，含 8 类风险的结构化标注，并刻画 reasoning/response 片段中的风险演化 | - |
...
| Benchmark | Paper | Venue & Year | Modality | Description / Highlights | Links |
| :-------- | :--- | :----------- | :------- | :----------------------- | :---- |
| **EgoSafetyBench** | [EgoSafetyBench: A Diagnostic Egocentric Video Benchmark for Evaluating Embodied VLMs as Runtime Safety Guards](https://arxiv.org/abs/2607.00218) | arXiv 2026 | `[V]`,`[M]` | 面向具身 VLM 运行时安全护栏的第一视角视频基准，含 1,200 个机器人视角场景和半秒级标注 | - |
| **SingGuard-Bench** | [SingGuard: A Policy-Adaptive Multimodal LLM Guardrail with Dynamic Reasoning](https://arxiv.org/abs/2606.22873) | arXiv 2026 | `[M]`,`[D]` | 多模态护栏基准，包含 5.6 万+ 样本、80+ 细粒度风险类型、动态规则评测与跨模态联合风险样例 | [Code](https://github.com/inclusionAI/Sing-Guard) |
...
| :---- | :--- | :----------- | :------- | :----------------------- | :---- |
| **DT-Guard** | [DT-Guard: Intent-Driven Reasoning-Active Training for Reasoning-Free LLM Safety Guardrail](https://arxiv.org/abs/2607.06326) | arXiv 2026 | `[T]` | 采用 reasoning-active training、reasoning-free inference 的低延迟安全护栏，将意图、类别和安全标签内化到模型中 | - |
| **HaloGuard 1.0** | [HaloGuard 1.0: An Open Weights Constitutional Classifier for Multilingual AI Safety](https://arxiv.org/abs/2607.02079) | arXiv 2026 | `[T]` | 开放权重 constitutional classifier，面向 46 条策略和 46 种语言的多语言 prompt safety | [HF](https://huggingface.co/collections/astroware/haloguard-10) |
| **kNNGuard** | [kNNGuard: Turning LLM Hidden Activations into a Training-Free Configurable Guardrail](https://arxiv.org/abs/2607.02072) | arXiv 2026 | `[T]` | 利用 LLM hidden activations 与少量安全/不安全 prompt bank 的免训练可配置护栏，支持快速领域适配 | - |
| **LeanGuard** | [Do Safety Guardrails Need to Reason? LeanGuard: A Fast and Light Approach for Robust Moderation](https://arxiv.org/abs/2606.26686) | arXiv 2026 | `[T]` | 轻量 label-only encoder 护栏，质疑 CoT 对审核任务的必要性，并报告相对推理型护栏约 100x 的计算下降 | [Code](https://github.com/ndb796/LeanGuard) |
...
| **IndicGuard** | [IndicGuard: A Multilingual Safety Guard Model and Dataset for Indic Languages](https://arxiv.org/abs/2606.22841) | arXiv 2026 | `[T]` | 面向十大印度语言的多语言安全护栏模型与文化细粒度数据集，覆盖本地化风险和越狱样例 | - |
...
| **SentGuard** | [SentGuard: Sentence-Level Streaming Guardrails for Large Language Models](https://arxiv.org/abs/2606.02041) | arXiv 2026 | `[T]` | 并行句子级流式护栏，在完整句子块释放前进行缓冲和审核 | - |
...
| **SafeHarbor** | [SafeHarbor: Hierarchical Memory-Augmented Guardrail for LLM Agent Safety](https://arxiv.org/abs/2605.05704) | ICML 2026 | `[T]` | 训练无关的层次化记忆增强 Agent 护栏，支持动态规则注入和自演进记忆结构 | [Code](https://github.com/ljj-cyber/SafeHarbor) |
...
| Model | Paper | Venue & Year | Modality | Description / Highlights | Links |
| :---- | :--- | :----------- | :------- | :----------------------- | :---- |
| **SingGuard** | [SingGuard: A Policy-Adaptive Multimodal LLM Guardrail with Dynamic Reasoning](https://arxiv.org/abs/2606.22873) | arXiv 2026 | `[M]`,`[D]` | 策略自适应多模态护栏模型族，支持运行时策略输入、规则级触发识别以及 fast/hybrid/slow 推理模式 | [Code](https://github.com/inclusionAI/Sing-Guard) |
...
| **SafeLens** | [SafeLens: Deliberate and Efficient Video Guardrails with Fast-and-Slow Screening](https://arxiv.org/abs/2605.17610) | arXiv 2026 | `[V]` | 采用 fast-and-slow screening 的视频护栏框架，结合 SafeWatch 数据筛选和测试时推理轨迹 | - |
...
| Attack | Paper | Venue & Year | Modality | Description / Highlights | Links |
| :----- | :--- | :----------- | :------- | :----------------------- | :---- |
| **Guardrail Recon** | [Behind the Refusal: Determining Guardrail Activation via Behavioral Monitoring](https://arxiv.org/abs/2607.02121) | arXiv 2026 | `[T]` | 黑盒护栏侦察方法，利用 HTTP、词汇和时序信号区分 guardrail block 与模型拒答 | - |
| **Guardrail DoS** | [From Shield to Target: Denial-of-Service Attacks on LLM-Based Agent Guardrails](https://arxiv.org/abs/2606.14517) | arXiv 2026 | `[T]` | 可用性攻击，将基于推理的 Agent 护栏困入长推理循环，造成 token 与延迟放大 | - |
...
| **Prompt Overflow** | [Prompt Overflow: What the Guardrail Inspects Is Not What the Model Infers](https://arxiv.org/abs/2605.23196) | arXiv 2026 | `[T]` | 利用护栏检查窗口与下游 LLM 推理窗口不一致的长上下文攻击 | - |
